...
@section('content')
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <ul class="dropdown-list user-list">
                  <li class="new">
                    <div class="thumb"><a href="{{asset('public/asset/#')}}"><img src="{{asset('public/asset/images/photos/user1.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="{{asset('public/asset/#')}}">Draniem Daamul (@draniem)</a> <span class="badge badge-success">new</span></h5>
                    </div>
                  </li>
                  <li class="new">
                    <div class="thumb"><a href="{{asset('public/asset/#')}}"><img src="{{asset('public/asset/images/photos/user2.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="{{asset('public/asset/#')}}">Zaham Sindilmaca (@zaham)</a> <span class="badge badge-success">new</span></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href="{{asset('public/asset/#')}}"><img src="{{asset('public/asset/images/photos/user3.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="{{asset('public/asset/#')}}">Weno Carasbong (@wenocar)</a></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href="{{asset('public/asset/#')}}"><img src="{{asset('public/asset/images/photos/user4.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="{{asset('public/asset/#')}}">Nusja Nawancali (@nusja)</a></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href="{{asset('public/asset/#')}}"><img src="{{asset('public/asset/images/photos/user5.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="{{asset('public/asset/#')}}">Lane Kitmari (@lane_kitmare)</a></h5>
                    </div>
                  </li>
                  <li class="new"><a href="{{asset('public/asset/#')}}">See All Users</a></li>
                </ul>
              </div>
            </div>
          </li>
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <ul class="dropdown-list gen-list">
                  <li class="new">
                    <a href="{{asset('public/asset/#')}}">
                    <span class="thumb"><img src="{{asset('public/asset/images/photos/user1.png')}}" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="{{asset('public/asset/#')}}">
                    <span class="thumb"><img src="{{asset('public/asset/images/photos/user2.png')}}" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="{{asset('public/asset/#')}}">
                    <span class="thumb"><img src="{{asset('public/asset/images/photos/user3.png')}}" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="{{asset('public/asset/#')}}">
                    <span class="thumb"><img src="{{asset('public/asset/images/photos/user4.png')}}" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="{{asset('public/asset/#')}}">
                    <span class="thumb"><img src="{{asset('public/asset/images/photos/user5.png')}}" alt="" /></span>
                    <span class="desc">
                  ...
                  <li class="new"><a href="{{asset('public/asset/#')}}">Read All Messages</a></li>
                </ul>
              </div>
            </div>
          </li>
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <ul class="dropdown-list gen-list">
                  ...
                  <li class="new"><a href="{{asset('public/asset/#')}}">See All Notifications</a></li>
                </ul>
              </div>
            </div>
          </li>
          <li>
            <div class="btn-group">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                <img src="{{asset('public/asset/images/photos/loggeduser.png')}}" alt="" />
                John Doe
                <span class="caret"></span>
              </button>
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                <li><a href="{{asset('public/asset/profile.html')}}"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
                <li><a href="{{asset('public/asset/#')}}"><i class="glyphicon glyphicon-cog"></i> Account Settings</a></li>
                <li><a href="{{asset('public/asset/#')}}"><i class="glyphicon glyphicon-question-sign"></i> Help</a></li>
                <li><a href="{{asset('public/asset/signin.html')}}"><i class="glyphicon glyphicon-log-out"></i> Log Out</a></li>
              </ul>
            </div>
          </li>
          <li>
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          <li><a href="{{asset('public/asset/index.html')}}">Bracket</a></li>
          ...
          <div class="panel panel-success panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{asset('public/asset/images/is-user.png')}}" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-danger panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{asset('public/asset/images/is-document.png')}}" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-dark panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{asset('public/asset/images/is-money.png')}}" alt="" />
                  </div>
                  <div class="col-xs-8">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <div class="panel panel-default widget-photoday">
            <div class="panel-body">
              <a href="{{asset('public/asset/#')}}" class="photoday"><img src="{{asset('public/asset/images/photos/photo1.png')}}" alt="" /></a>
              <div class="photo-details">
                ...
                <small>By: <a href="{{asset('public/asset/#')}}">ThemePixels</a></small>
              </div><!-- photo-details -->
              <ul class="photo-meta">
                <li><span><i class="fa fa-eye"></i> 32,102</span></li>
                <li><a href="{{asset('public/asset/#')}}"><i class="fa fa-heart"></i> 1,003</a></li>
                <li><a href="{{asset('public/asset/#')}}"><i class="fa fa-comments"></i> 52</a></li>
              </ul>
            </div><!-- panel-body -->
          </div><!-- panel -->
        </div><!-- col-sm-6 -->
        ...
        <div class="col-sm-6 col-md-4">
          ...
          <div class="panel-heading">
              <div class="panel-btns">
                <a href="{{asset('public/asset/#')}}" class="panel-edit"><i class="fa fa-edit"></i></a>
              </div><!-- panel-btns -->
        ...
        <div class="col-sm-6 col-md-4">
          ...
          <div class="panel-heading">
              <div class="panel-btns">
                <a href="{{asset('public/asset/#')}}" class="panel-close">&times;</a>
                <a href="{{asset('public/asset/#')}}" class="minimize">&minus;</a>
              </div><!-- panel-btns -->
              <h3 class="panel-title">Quick Status Post</h3>
            </div>
            <div class="panel-body">
              <ul class="nav nav-tabs nav-justified">
                <li class="active"><a href="{{asset('public/asset/#post-status')}}" data-toggle="tab"><i class="fa fa-pencil"></i> <strong>Status</strong></a></li>
                <li><a href="{{asset('public/asset/#post-photo')}}" data-toggle="tab"><i class="fa fa-picture-o"></i> <strong>Photo</strong></a></li>
                <li><a href="{{asset('public/asset/#post-checkin')}}" data-toggle="tab"><i class="fa fa-map-marker"></i> <strong>Check-In</strong></a></li>
              </ul>
